...
- (void)notifyDir:(CGPoint)dir
{
    ...
    [notificationCenter postNotificationName:@"DirectionChangedNotification" object:nil userInfo:userInfo];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    NSNotificationCenter *notificationCenter = [NSNotificationCenter defaultCenter];
    [notificationCenter postNotificationName:@"DirectionChangedStopNotification" object:nil userInfo:nil];
}
